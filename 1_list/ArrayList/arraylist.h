...
/* 
Why we use maxElementCount, currentElemenCount variable? : 
the domain which is not allocated/initiated yet, can show it's value as 0.
so it cannot be distinguished whether it has value of 0 that i allocated, or it is just a intial value.
That's why we use those variables.
*/
